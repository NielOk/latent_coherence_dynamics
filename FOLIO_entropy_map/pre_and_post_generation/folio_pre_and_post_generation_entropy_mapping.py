...
def main():
    ...
    for i in range(len(input_ids_list)):
        ...
        mean_pre_generation_entropy, max_pre_generation_entropy = calculate_pre_generation_entropy(model, input_ids, steps=NUM_STEPS, gen_length=TOKENS_TO_GENERATE, block_length=BLOCK_LENGTH)
        ...
        # post-generation entropy
        mean_post_generation_entropy, max_post_generation_entropy = calculate_post_generation_entropy(model, input_ids, steps=NUM_STEPS, gen_length=TOKENS_TO_GENERATE, block_length=BLOCK_LENGTH)
        ...
        prompt_entropy_dict[prompt] = {
            "pre_generation_entropy": {
                "mean": mean_pre_generation_entropy.item(),
                "max": max_pre_generation_entropy.item()
            },
            "post_generation_entropy": {
                "mean": mean_post_generation_entropy.item(),
                "max": max_post_generation_entropy.item()
            }
        }
